...
public class All_UI_Touch : MonoBehaviour
{
    ...
    string hit_object_name;
    Vector3 hit_object_pos;
    Vector3 hit_object_rot;
    ...
    //터치 시간
    float placement_touch_time = 0.0f;
    //터치 상태
    bool placement_touch_state = false;
    ...
    bool placement_move_just_one = false;
    bool now_ui_touching = false;
